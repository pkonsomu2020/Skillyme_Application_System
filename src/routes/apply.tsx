...
function Step({ n, title, detail }: { n: string; title: string; detail: string }) {
  return (
    <div className="flex-1 px-4 text-center md:px-6">
      <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#D4AF37", opacity: 0.6, fontSize: 28 }}>
        {n}
      </div>
      <div className="mt-2" style={{ color: "#fff", fontWeight: 500, fontSize: 14, letterSpacing: "0.08em", textTransform: "uppercase" }}>
        {title}
      </div>
      <div className="mt-2" style={{ color: "#D8F3DC", fontWeight: 300, fontSize: 13, lineHeight: 1.6 }}>
        {detail}
      </div>
    </div>
  );
    ...
    <>
      ...
      <section className="city-section city-overlay-72" style={{ padding: "160px 24px 100px", textAlign: "center" }}>
        <div className="mx-auto max-w-[900px]">
          ...
          <p
            ...
            style={{ color: "#D8F3DC", fontWeight: 300, fontSize: 18, maxWidth: 560, lineHeight: 1.6 }}
          >
          ...
          <div className="anim-fade-in delay-600 mt-12 flex flex-wrap items-center justify-center gap-x-16 gap-y-8">
            {[
              ...
              <div key={s.l} className="text-center">
                <div style={{ fontFamily: "var(--font-display)", fontWeight: 700, color: "#D4AF37", fontSize: 36 }}>
                  {s.n}
                </div>
                <div
                  className="mt-1"
                  style={{ color: "#D8F3DC", fontWeight: 300, fontSize: 13, letterSpacing: "0.08em", textTransform: "uppercase" }}
                >
                  {s.l}
                </div>
              </div>
          ...
          <div className="mx-auto mt-12" style={{ height: 1, width: 80, background: "rgba(212,175,55,0.4)" }} />
          ...
          <div className="mt-12">
            ...
            <div className="hidden items-stretch md:flex">
              ...
              <div style={{ alignSelf: "center", color: "#D4AF37", opacity: 0.5, fontSize: 24, fontFamily: "var(--font-display)" }}>→</div>
            ...
            <div className="md:hidden">
              {[
                ...
                <div key={s.n} className="py-5" style={{ borderBottom: i < arr.length - 1 ? "1px solid rgba(212,175,55,0.3)" : "none" }}>
      ...
      <section className="bg-white" style={{ padding: "80px 0 0 0" }}>
        <div className="mx-auto max-w-[860px] px-6 md:px-10">
          <div className="text-center" style={{ color: "#555", fontSize: 12, letterSpacing: "0.08em", textTransform: "uppercase" }}>
            APPLICATION FORM — TRACK ONE, MAY 2026
          </div>
          <div className="mx-auto mt-8" style={{ height: 1, background: "rgba(212,175,55,0.2)" }} />
          ...
          >
            {iframeFailed ? (
              <div className="text-center" style={{ padding: 60, color: "#555", fontWeight: 300, fontSize: 16 }}>
          ...
          <div
            ...
            style={{ borderTop: "1px solid #EDF7F0" }}
          >
            <div style={{ color: "#555", fontWeight: 300, fontSize: 14, fontStyle: "italic" }}>
              You will not be charged until you receive an acceptance email and confirm your spot.
            </div>
            <div style={{ color: "#555", fontWeight: 300, fontSize: 13 }}>
      ...
      {/* KEY DATES */}
      <section className="px-6 py-24 md:px-10" style={{ background: "#EDF7F0" }}>
        <div className="mx-auto max-w-[900px]">
          <Reveal>
            <div className="gold-label">KEY DATES</div>
            <h2 className="mt-4" style={{ fontFamily: "var(--font-display)", color: "#1B4332", fontWeight: 600, fontSize: 38 }}>
              Write these down. They do not move.
            </h2>
          </Reveal>

          <div className="relative mt-12 pl-8" style={{ borderLeft: "1px solid #D4AF37" }}>
            {[
              ...
              <Reveal key={e.d}>
                <div className="relative mb-8">
                  <div
                    className="absolute"
                    style={{ left: -39, top: 8, width: 12, height: 12, background: "#D4AF37" }}
                  />
                  <div className="gold-label" style={{ color: "#1B4332" }}>{e.d}</div>
      ...
      {/* BOTTOM CTA */}
      <section className="city-section city-overlay-soft" style={{ padding: "80px 24px", textAlign: "center" }}>
        <h3
          className="city-heading"
          style={{ fontFamily: "var(--font-display)", color: "#fff", fontWeight: 600, fontSize: 36 }}
        >
          Applications close May 14, 2026.
        </h3>
        <p className="city-text mt-2" style={{ color: "#D8F3DC", fontWeight: 300, fontSize: 18 }}>
          100 spots. Not 101.
        </p>
        <button
