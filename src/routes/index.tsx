      ...
      <section className="bg-white" style={{ padding: "100px 0" }}>
        <div className="mx-auto px-6 md:px-10" style={{ maxWidth: 880 }}>
          ...
          <div className="mt-12">
            ...
            <Reveal><QA q="What if my team loses?" a="The team that places second earns 5% of commercial revenue — this is not a consolation. It is a deliberate structure. The competing team pushed the winning team to build better, and that competitive pressure is part of what makes the winning product worth buying. They are compensated for that. The 25% that goes to Skillyme Africa covers the management of every client secured at the Gala — maintenance of the system, monthly client support, and every operational need that keeps the product running after the program ends. This is not a fee for running the program. It is payment for the ongoing work of keeping real clients satisfied month after month. Full IP rights are available to any team that can demonstrate they are capable of handling their clients' needs completely and independently — from technical maintenance to client communication to every delivery, every month, alongside their daily lives. Any team ready to make that full commitment can claim them." /></Reveal>
            ...
            <Reveal><QA q="Does the second team get anything?" a="The team that places second earns 5% of commercial revenue. This is not a consolation. It is a deliberate structure. The competing team pushed the winning team to build better, and that competitive pressure is part of what makes the winning product worth buying. They are compensated for that." /></Reveal>
            <Reveal><QA q="Why does Skillyme Africa receive 25%?" a="The 25% that goes to Skillyme Africa covers the management of every client secured at the Gala — maintenance of the system, monthly client support, and every operational need that keeps the product running after the program ends. This is not a fee for running the program. It is payment for the ongoing work of keeping real clients satisfied month after month." /></Reveal>
            <Reveal><QA q="Can teams get full IP rights to their product?" a="Full IP rights are available to any team that can demonstrate they are capable of handling their clients' needs completely and independently — from technical maintenance to client communication to every delivery, every month, alongside their daily lives. Any team ready to make that full commitment can claim them." /></Reveal>
          </div>
        </div>
      </section>
